...
# Add arguments
parser.add_argument('-r', '--map', type=int, default=1, help='map number')
...
# map
tiled_map = Tiledmap()
tiled_map.load(map_number)

#map_map = tiled_map.data.properties['mapMap']
#
## Heightmap
#heightmap = Heightmap()
#heightmap.load(map_map)
#
## Hero
